package com.halas.service.rest.consts;

public class ConstCopterREST {
    public static final String SUCCESS_ACTION = "The action was SUCCESSFUL.";
    public static final String ID_EXIST_BAD_FORMAT = "The action was FAILURE, because copter with ID:\"%s\" already exists.";
    ...
    public static final String COPTER_IS_NULL = "Copter is not defined!";
